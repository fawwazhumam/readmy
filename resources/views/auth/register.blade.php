...
<body>
  <div id="app" class="w-full min-h-screen h-max p-12 flex justify-center items-center bg-[url('../images/bg-login.jpg')] bg-no-repeat bg-cover bg-center">
    <div id="wrapper" class="bg-white bg-opacity-80 p-8 w-[32rem] rounded-lg border-2 border-white">
      ...
      <form method="POST" action="{{ route('register') }}" class="flex flex-col items-center px-8">
        ...
        <div class="px-8 pt-4 pb-8 border-t-2 border-secondary w-full flex flex-col gap-4 justify-center items-center">
          <p class="font-bold">OR</p>
          <button type="button" class="px-8 py-2 rounded-full bg-primary text-white font-bold hover:bg-green-600 duration-300">
